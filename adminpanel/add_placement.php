  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Add College Placements</table></table></h4>
	   ...
	   <table class="table  table-striped table-hover" style="text-align:center;margin-top:30px;width:100%">
			...
			<tbody>
              <tr >
                ...
                <td><input  type="text" required placeholder="Enter Company Name" style="outline:none;text-align:center;margin:0px;padding:5px;border:none;min-width:1px;" name="company" >
                </td>
				<td><input  type="text" required placeholder="Enter Total Selection" style="outline:none;text-align:center;margin:0px;padding:5px;border:none;min-width:1px;" name="placements" >
                </td>
				<td><input  type="text" required placeholder="Enter Placement Year" style="outline:none;text-align:center;margin:0px;padding:5px;border:none;min-width:1px;" name="year" >
                </td>
			</tr>
			</tbody>
			</table>
...
if(isset($_POST['add']))
{
  ...
  $query_college="insert into placement (college_name,company_name,selections,year) values ('$college_name','$company','$placements','$year')";
