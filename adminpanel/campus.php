	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title">list of all Campus Explorer items</h4>
				...
				<div class="table-responsive">
					<table class="table table-striped"style="text-align: center;" valign="center">
						<tr>
                            ...
                            <th>Timeing</th>
                            <th style="width:300px" width="300px">Description</th>
                            <th>Status</th>
                        ...
                        <?php 
                              ...
                              while ($result=mysqli_fetch_array($query)) {
                                  echo "<tr>
                                              <td>" .$result['name']." 
                                                  <a href='product_img/campus_exp/".$result['campus_img']."'>
                                                  <image style='height:100px' src='product_img/campus_exp/".$result['campus_img']."'>
                                                  </a>
                                              </td> 
                                              <td>".$result['type']."</td> 
                                              <td>".$result['location']."</td>
                                              <td>".$result['owner_nm']."<br>".$result['phone']."<br>".$result['mail']."</td>
                                              <td>".$result['op_cl_time']."</td>
                                              <td> <textarea cols='60' rows='5' disabled 
                                              style='text-align:center;background: 0;margin:0px;padding:5px;border:none;min-width:1px;outline:none'
                                              >".$result['decr']."</textarea></td>
                                              <td>".$result['status']."</td>
                                              <td >
                                                <a class='update_btn' href='campus_update_page.php?id=".$result['id']."'>	
                                                  <button class='btn btn-glow btn-bg-gradient-x-purple-blue round '>Update</button> 
                                                </a>
                                              </td>
                                              <td >
                                                <a class='delete_btn' href='delete_update_query/delete_from_campus.php?id=".$result['id']."'>	
