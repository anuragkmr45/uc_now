  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-7 col-md-12">
        <h1 class="title"><span>IPU Campus </span>Colleges</h1>
      ...
      <div class="col-lg-5 col-md-12 text-lg-right md-mt-3">
        <nav aria-label="breadcrumb" class="page-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">IPU Campus
            </li>
          </ol>
        </nav>
      </div>
                    ...
                    <div class="col-md-9 sm-mt-2">
                        <div class="form-group mb-0">
                            ...
                            <datalist id="coll_list">
                                <?php
                                    $query2=mysqli_query($conn,"select * from college where campus='ipu'");
    ...
    <div class="row text-center">
      <div class="col-lg-8 col-md-10 ml-auto mr-auto">
        <div class="section-title">
          <h2 class="title">IPU Campus<br> <span>Colleges</span></h2>
          <div class="title-bdr">
